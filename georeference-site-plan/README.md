...
4. Draw the line following the site plan pattern which has been georeferenced. This process called Site Plan Digitization. If all is done, click **Save Layer Edits**.
...
## Credit
* Best documentation on https://github.com/mocatfrio/GIS-2018
