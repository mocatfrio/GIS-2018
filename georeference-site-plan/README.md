...
3. Open base map vector files of Sidoarjo district.
    * Click **Add Vector Layer** on the vector toolbar (marked by red rectangle).
      ...
      ![screenshot-1](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/1.png "Figure 1")

    * Click **browse**.
  
      ![screenshot-2](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/2.png "Figure 2")

    * Select all the **.shp** files, then click **open**.
  
      ![screenshot-3](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/3.png "Figure 3")

    * The Coordinate Reference System Selector dialogue will appear. Just leave it default **(WGS 84)**, then click **OK**.
  
      ![screenshot-4](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/4.png "Figure 4")
...
4. All the **.shp** files are loaded, then set and sort the files as needed. We can swap the position (just drag and drop), press the check mark to disable or enable, change the color, or remove them.
    ...
    ![screenshot-5](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/5.png "Figure 5")
    ...
    ![screenshot-6](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/6.png "Figure 6")
...
1. Take a screenshot of **Bluru Kidul Village** area because the site plan is located on Bluru Kidul Village.
    ...
    ![screenshot-bluru-kidul](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/desa-bluru-kidul.png "Figure 7")

2. Take a screenshot again of **Puskopkar** area to make the maps more detail.
   
    ![screenshot-puskopkar](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/puskopkar.png "Figure 8")
...
1. Install the **Georeferencer GDAL** plugin first. Click **Plugins** on the menu toolbar > **Manage and Install Plugins** > Search **Georeference GDAL** > Check the box to enable the plugin
    ...
    ![screenshot-7](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/7.png "Figure 9")
...
2. To do georeferencing, click **Raster** on the menu toolbar > Click **Georeferencer** > Click **Georeferencer**, then a georeferencer dialogue will appear. Click **Open Raster**.
    ...
    ![screenshot-8](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/8.png "Figure 10")
...
4. Click **Add Point** to tag some georeference points on **Raster Image** and **Vector Image**. I add 5 points in this georeference (at least 3 points, more is better).
    ...
    ![screenshot-9](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/9.png "Figure 11")
   
5. After add some points, then click **Start Georeferencing**.
   
    ![screenshot-10](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/10.png "Figure 12")

    Follow the transformation settings below. 

    ![screenshot-11](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/11.png "Figure 13")
...
6. Georeference of Bluru Kidul Village screenshot done with mean error **0.291192** (figure 12).
    ...
    ![screenshot-12](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/12.png "Figure 14")
...
3. Click **Add Point** to tag some georeference points on **Raster Image** and **Vector Image**. I add 5 points in this georeference (at least 3 points, more is better).
   ...
   ![screenshot-13](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/13.png "Figure 15")
...
5. Georeference of Puskopkar screenshot done with mean error **0.205479** (figure 15).
    ...
    ![screenshot-14](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/14.png "Figure 16")
...
3. Click **Add Point** to tag some georeference points on **Raster Image** and **Vector Image**. I add 4 points in this georeference (at least 3 points, more is better).
   ...
   ![screenshot-15](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/15.png "Figure 17")

4. After add some points, then click **Start Georeferencing**. Use **Polynomial 1** transformation type.
5. Georeference of PUSKOPKAR -TAMAN GRAHA PENTA SIDOARJO - DS. BLURU KIDUL site plan done with mean error **0.544327** (figure 17).
   
    ![screenshot-16](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/16.png "Figure 18")
...
2. The New Shapefile Layer dialogue will appear. Select **Line** type and fill the new layer's name.
    ...
    ![screenshot-17](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/17.png "Figure 19")

    Then, a new layer will be created in the layers panel.

    ![screenshot-18](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/18.png "Figure 20")
    
3. Select the new shapefile layer. Click **Toggle Editing** on the plugin toolbar, then click **Add Feature**.

    ![screenshot-19](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/19.png "Figure 21")
...
4. Draw the line following the site plan which has been georeferenced. This process called Site Plan Digitization. If all is done, click **Save Layer Edits**.
    ...
    ![screenshot-20](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/20.png "Figure 22")

6. Finally, save the projects (Ctrl+S) and Site Plan Digitization is done!

    ![screenshot-21](https://github.com/mocatfrio/GIS-2018/tree/master/georeference-site-plan/img/21.png "Figure 23")
